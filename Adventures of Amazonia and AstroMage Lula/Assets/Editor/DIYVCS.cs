...
public class DIYVCS : EditorWindow
{
	...
	public static void exportPackage()
	{
		...
		{
			projectContent = new string[] { "Assets", "ProjectSettings", "Packages" };
		}
		else
		{
			...
			else
			{
				...
				{
					projectContent = new string[] { "Assets", "Packages" };
				}
				else
				{
		...
		AssetDatabase.ExportPackage(projectContent, projectName + System.DateTime.UtcNow.ToString("yyyyMMddhhmmss") + ".unitypackage", ExportPackageOptions.Interactive | ExportPackageOptions.Recurse | ExportPackageOptions.IncludeDependencies);
